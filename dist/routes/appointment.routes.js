...
appointmentsRouter.put('/update/:id', auth_middleware_1.authenticateToken, appointment_controller_1.updateAppointment);
appointmentsRouter.delete('/delete/:id', auth_middleware_1.authenticateToken, appointment_controller_1.deleteAppointment);
